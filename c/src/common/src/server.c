...
int main()
{
	...
	l_fd = socket(AF_INET, SOCK_STREAM, 0);	/* Use TCP protocol to create a socket. */
	...
	while (1)
	{
		...
		write(c_fd, buf, n);	/* Send the content which has been converted into lower case to the client. */
