#!/bin/bash
# Program:
#	This is a tool to manage users of this system.
# History:
# 2013/10/28	tom	First release
...
case $1 in
	-adduser)
		[ $# -ne 3 ] && usage; useradd $2 -p $3 -m
		;;
	-deluser)
		[ $# -ne 2 ] && usage; userdel $2 --remove-all-files
		;;
	-shell)
		[ $# -ne 3 ] && usage; chsh $2 -s $3
		;;
	-disable)
		[ $# -ne 2 ] && usage; usermod -L $2
		;;
	-enable)
		[ $# -ne 2 ] && usage; usermod -U $2
		;;
	-expiry)
		[ $# -ne 3 ] && usage; chage $2 -E $3
		;;
	-passwd)
		[ $# -ne 2 ] && usage; passwd $2
		;;
	-newgroup)
		[ $# -ne  2 ] && usage; groupadd $2
		;;
	-delgroup)
		[ $# -ne 2 ] && usage; groupdel $2
		;;
	-addgropu)
		[ $# -ne 3 ] && usage; addgroup $2 $3
		;;
	-details)
		[ $# -ne 2 ] && usge; finger $2; chage -l $2
		;;
	*)
		usage
		;;
